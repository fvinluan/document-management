...
public class FolderController {
    ...
    @PostMapping
    public ResponseEntity<ApiResponse<FolderDTO>> createFolder(@RequestBody @Validated FolderRequest request) {
    ...
    public ResponseEntity<ApiResponse<FolderDTO>> updateFolder(
        ...
        return ResponseEntity.ok(ApiResponse.success(folderService.updateFolder(id, request), "Folder updated successfully"));
    }
